...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=280&section=header&text=Saghar%20Mehmood&fontSize=60&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=AI%20Engineer%20%F0%9F%9A%80%20%7C%20Deep%20Learning%20%E2%80%A2%20Computer%20Vision%20%E2%80%A2%20Multimodal%20AI&descAlignY=56&descAlign=50&descSize=20"/>

<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=20&duration=3000&pause=1000&color=6A5ACD&center=true&vCenter=true&width=700&lines=Building+Multimodal+AI+Systems+beyond+traditional+ML;EEG+%2B+Voice+%2B+Vision+%E2%80%94+Unified+AI+Pipelines;Deep+Learning+%7C+Signal+Processing+%7C+Backend+AI;BS+Artificial+Intelligence+Graduate+%F0%9F%8E%93" alt="Typing SVG" />
...
- 🎥 **LSTM Video Model** → **93% accuracy** (Facial Expression Sequence Modeling)
- 🧠 **XGBoost EEG Model** → **83% accuracy** (Brainwave Pattern Classification)
- 🎤 **XGBoost Audio Model** → **88% accuracy** (Acoustic Feature-Based Prediction)
- ⚡ **Flask REST APIs** → Real-time AI inference backend
- 📡 **EEG Pipeline** → Alpha, Beta, Gamma, Theta, Delta frequency decomposition
- 👁️ **Vision Pipeline** → Facial analysis with OpenCV & DeepFace

> 🔭 *Building multimodal AI systems that fuse EEG, vision, and voice — beyond traditional single-modal ML*
...
AI-powered deception detection system that fuses **EEG brain signals**, **facial expressions**, and **voice analysis** into a single unified multimodal prediction pipeline.

| 🔬 Modality | 🤖 Model | 📊 Accuracy |
|:---|:---|:---:|
| 🎥 Video / Facial Expressions | LSTM | **93%** |
| 🧠 EEG Brain Signals | XGBoost | **83%** |
| 🎤 Audio / Voice Analysis | XGBoost | **88%** |
...
Built end-to-end preprocessing and feature extraction workflows for EEG biosignal analysis. Full frequency band decomposition for XGBoost classification input.
...
LSTM-based facial landmark sequence modeling combined with Librosa acoustic feature extraction for multimodal behavioral analysis.
...
### ⚡ *"Building intelligent systems beyond traditional AI — one model at a time."*
